...
{no:82, unit:1, subno:1, vd:1, word:`Vた、Adj ＋ ことに `, mean: `Dùng vs mục đích nhấn mạnh`},
{no:83, unit:1, subno:1, vd:1, word:`N ＋ にしては `, mean: `Khác với những gì dự đoán.`},
{no:84, unit:1, subno:1, vd:1, word:`このお弁当は300円にして量も多い味もいい。 `, mean: `Hộp cơm này, với giá 300 Yên vừa rẻ lại vừa nhiều`},
{no:85, unit:1, subno:1, vd:1, word:`PI ＋ ことか `, mean: `(cảm thán) nói về điều mình đã làm đến bây giờ, hoặc điều đang cảm nhận.
ê nào nếu pass bài kiểm tra.`},
{no:86, unit:1, subno:1, vd:1, word:`さえ ば `, mean: `Chỉ cần ~(là điều kiện thiết yếu)`},
{no:87, unit:1, subno:1, vd:1, word:`給料さえよければどんな仕事でもいい。 `, mean: `Nếu lương cao, bất cứ công việc nào đều tốt`},
{no:88, unit:1, subno:1, vd:1, word:`V + ようがない `, mean: `Không còn phương pháp nào để ~
Không còn cách nào, không thể ~
N2を合格しない、BRSEをなりようがない・
Không có chứng chỉ N2, đừng mơ BRSE`},
{no:89, unit:1, subno:1, vd:1, word:`Vた ＋ あげく `, mean: `Sau ~ rốt cục là ~
このチケットは８時間並んだあげくにやっと手に入れたものだ。
Kết thúc 8 tiếng xếp hàng, cuối cùng cũng có được vé.`},
{no:90, unit:1, subno:1, vd:1, word:`Vる ＋ ものではない、もんじゃない `, mean: `Không được làm ~
Không nên làm ~
社内のことは小さいことでも、部外者に話すものではない。
Chuyện trong công ty dù nhỏ cũng ko lên nói cho người ngoài biết.`},
{no:91, unit:1, subno:1, vd:1, word:`Vる ＋ だけ ＋ V `, mean: `Có lẽ không được nhưng thử làm
