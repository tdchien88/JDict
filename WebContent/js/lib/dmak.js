 ;(function () {
	...
	Dmak.default = {
		uri: "js/lib/kanji/",     // path to the SVG files folder.
		skipLoad: false,          // skip SVG files loading.
		autoplay: true,           // start drawing as soon as all SVG files are loaded.
		height: 109,              // height in pixels of a single paper surface.
		width: 109,               // width in pixels of a single paper surface.
		viewBox: {                // position of the canvas.
			x: 0,
			y: 0,
			w: 109,
			h: 109
		...
		stroke: {
			animated : {
				drawing : true,             // enable or disable stroke animation.
				erasing : true              //
			},
			order: {                        // step number
				visible: true,              // display stroke order.
				attr: {                     //
					"font-size": "8",       // stroke order font size in pixels.
					"fill": "#999999"       // color
				}
			},
			attr: {                         //
				"active": "#BF0000",        // currently drawn stroke color.
				"stroke": "random",         // may use the keyword "random" here for random color - #2C2C2C
				"stroke-width": 4,
				"stroke-linecap": "round",  // ["butt", "square", "round"]. default 'round'
				"stroke-linejoin": "round"  // ["bevel", "round", "miter"]. default 'round'
			}
		},
		grid: {                             //
			show: true,                     // show or hide gridlines.
			attr: {
				"stroke": "#CCCCCC",
				"stroke-width": 0.5,        // grid width in pixels.
				"stroke-dasharray": "--"    //  ["", "-", ".", "-.", "-..", ". ", "- ", "--", "- .", "--.", "--.."]. "--"
			}
		},
		loaded: function () {
